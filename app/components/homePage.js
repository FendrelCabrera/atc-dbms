...
const TourCarousel = () => {
  return (
    <Carousel className='col-md-6'>
      <Carousel.Item>
      <img className="d-block w-100" src="/dubai.png" alt="First slide" />
      </Carousel.Item>
      <Carousel.Item>
      <img className="d-block w-100" src="/bangalore.png" alt="Second slide" />
      </Carousel.Item>
      <Carousel.Item>
      <img className="d-block w-100" src="/calicut.jpg" alt="Third slide" />
      </Carousel.Item>
    </Carousel>
  )
}